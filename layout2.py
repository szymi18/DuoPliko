...
class Ui_DuoPliko(object):
    def setupUi(self, DuoPliko):
        ...
        self.user_info2 = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        self.user_info2.setStyleSheet("color: red")
        self.user_info2.setText("")
        self.user_info2.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.user_info2.setObjectName("user_info2")
        self.verticalLayout.addWidget(self.user_info2)
        ...
        self.file_compare_button = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        self.file_compare_button.setObjectName("file_compare_button")
        self.horizontalLayout_3.addWidget(self.file_compare_button)
    ...
    def retranslateUi(self, DuoPliko):
        ...
        self.file_compare_button.setText(_translate("DuoPliko", "Sprawdź podobieństwo"))
